<?php
/* General stuff */
$LANGS['language'] = 'Português (BR)';
$LANGS['languageenglish'] = 'Português (BR)';
$LANGS['languagecode'] = 'pt_BR.UTF-8'; /* Leave the ".UTF-8" in the end as-is, as it might break some dates */
$LANGS['languagechange'] = 'Idioma mudado para português.';
...
/* Language window */
$LANGS['welcometobitview'] = 'Bemvindo a BitView!';
$LANGS['languagesuggestion'] = 'Idioma Sugerido (definimos sua preferência para este):';
$LANGS['languagesuggestiondesc1'] = 'Para alterar sua preferência de idioma, use o seletor de idioma no final da página.';
$LANGS['languagesuggestiondesc2'] = 'Clique em "OK" para aceitar esta configuração ou clique em "Cancelar" para visualizar o site em inglês.';
...
$LANGS['months'] = 'meses';
$LANGS['years'] = 'anos';
$LANGS['ago1'] = 'há'; /* Explanation: Text before "x seconds/minutes/hours..." Example: "hace (1 día)" in Spanish. If your language doesn't use this, leave it empty like this: ''*/
...
$LANGS['logout'] = 'Sair';
$LANGS['upload'] = 'Criar Video';
$LANGS['subscriptions'] = 'Assinaturas';
$LANGS['history'] = 'História';
$LANGS['account'] = 'Conta';
...
$LANGS['beingwatched'] = 'Vídeos Sendo Assistido Agora';
$LANGS['featured'] = 'Vídeos Destacados';
$LANGS['mostpopular'] = 'Mais Popular';
$LANGS['inboxstats'] = 'Notificações e Estáticas';
$LANGS['profilesettings'] = 'Configurações da Conta';
$LANGS['messages'] = 'Mensagens';
$LANGS['message'] = 'Mandar Mensagem';
$LANGS['comments'] = 'Comentários';
$LANGS['comment'] = 'Comentar';
